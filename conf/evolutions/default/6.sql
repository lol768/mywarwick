...
CREATE TABLE TILE (
  ...
  CONSTRAINT "TILE_PK" PRIMARY KEY ("TYPE")
);

CREATE TABLE USER_TILE (
  "USERCODE"      NVARCHAR2(100),
  "TILE_TYPE"     NVARCHAR2(100),
  "TILE_POSITION" INT          NOT NULL,
  "TILE_SIZE"     NVARCHAR2(100),
  "CREATED_AT"    TIMESTAMP(6) NOT NULL,
  "UPDATED_AT"    TIMESTAMP(6) NOT NULL,
  CONSTRAINT "USER_TILE_PREF_FK" FOREIGN KEY ("TILE_TYPE") REFERENCES TILE ("TYPE"),
  CONSTRAINT "USER_TILE_PREF_PK" PRIMARY KEY ("USERCODE", "TILE_TYPE")
);
