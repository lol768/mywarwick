...
class AnalyticsReportServiceImpl @Inject()(
  ...
  //view id for guest
  val VIEW_ID_GUEST = config.getOptional[String]("mywarwick.analytics.view-id.guests")
  ...
  val VIEW_ID_LOGGED_IN_USER = config.getOptional[String]("mywarwick.analytics.view-id.users")
