...
trait MessagingDao {
  ...
  def save(activity: Activity, usercode: Usercode, output: Output, sendAt: Option[ZonedDateTime])(implicit c: Connection): Unit
  ...
  def updateMessageSendAtForUser(usercode: Usercode, sendAt: Option[ZonedDateTime])(implicit c: Connection): Unit
}
...
class MessagingDaoImpl extends MessagingDao {
  ...
  override def save(activity: Activity, usercode: Usercode, output: Output, sendAt: Option[ZonedDateTime])(implicit c: Connection): Unit = {
  ...
  override def updateMessageSendAtForUser(usercode: Usercode, sendAt: Option[ZonedDateTime])(implicit c: Connection): Unit =
