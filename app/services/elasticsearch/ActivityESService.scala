...
class ActivityESServiceImpl @Inject()(
  ...
  elasticSearchAdminService.putTemplate(ActivityESServiceIndexHelper.indexPatternsForActivityAndAlert, "activity_alert_template_default")
  elasticSearchAdminService.putTemplate(ActivityESServiceIndexHelper.indexPatternsForDeliveryReports, "delivery_report_template_default")
