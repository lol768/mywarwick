...
ALTER TABLE PROVIDER ADD PUBLISHER_ID NVARCHAR2(100);

UPDATE PROVIDER SET PUBLISHER_ID='315d3e23-614e-4d5a-b27f-703cdb834c9b' WHERE PUBLISHER_ID IS NULL; -- default publisher
ALTER TABLE PROVIDER ALTER PUBLISHER_ID SET NOT NULL;
