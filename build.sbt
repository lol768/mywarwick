...
val appDeps = Seq(
  ...
  "com.google.apis" % "google-api-services-analyticsreporting" % "v4-rev133-1.25.0"
  ...
  "com.vladsch.flexmark" % "flexmark" % "0.42.4",
  "com.vladsch.flexmark" % "flexmark-ext-autolink" % "0.42.4",
  "com.googlecode.libphonenumber" % "libphonenumber" % "8.10.9",
